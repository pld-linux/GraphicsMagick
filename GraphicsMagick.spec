...
%description -l uk
GraphicsMagick - ÃÅ ÕÔÉÌ¦ÔÁ ÄÌÑ ÐÅÒÅÇÌÑÄÕ, ËÏÎ×ÅÒÔÕ×ÁÎÎÑ ÔÁ ÏÂÒÏÂËÉ
ÚÏÂÒÁÖÅÎØ. ÷ÏÎÁ ÐÒÁÃÀ¤ Ð¦Ä X Window. GraphicsMagick ÄÁ¤ ËÏÒÉÓÔÕ×ÁÞÕ
ÛÉÒÏË¦ ÍÏÖÌÉ×ÏÓÔ¦ ÐÏ ÏÂÒÏÂÃ¦ ÚÏÂÒÁÖÅÎØ × Ò¦ÚÎÏÍÁÎ¦ÔÎÉÈ ÆÏÒÍÁÔÁÈ.
...
Â¦ÂÌ¦ÏÔÅËÉ ÄÌÑ ×ÉËÏÒÉÓÔÁÎÎÑ × ÐÒÏÇÒÁÍÁÈ, ÝÏ ×ÉËÏÒÉÓÔÏ×ÕÀÔØ ËÏÄ ÁÂÏ API
GraphicsMagick.
...
Summary(uk):	óÔÁÔÉÞÎ¦ Â¦ÂÌ¦ÏÔÅËÉ ÄÌÑ ÐÒÏÇÒÁÍÕ×ÁÎÎÑ Ú GraphicsMagick
Group:		X11/Development/Libraries
...
ãÅ ÏËÒÅÍÉÊ ÐÁËÅÔ Ú¦ ÓÔÁÔÉÞÎÉÍÉ Â¦ÂÌ¦ÏÔÅËÁÍÉ, ÑË¦ Â¦ÌØÛÅ ÎÅ ×ÈÏÄÑÔØ ÄÏ
...
Summary(uk):	â¦ÂÌ¦ÏÔÅËÁ Magick++ (¦ÎÔÅÒÆÅÊÓ C++ ÄÌÑ GraphicsMagick)
Group:		X11/Libraries
Requires:	%{name}-libs = %{version}-%{release}
...
%description c++ -l uk
Magick++ -- ÏÂ'¤ËÔÏ-ÏÒ¦¤ÎÔÏ×ÁÎÁ Â¦ÂÌ¦ÏÔÅËÁ, ÝÏ Ñ×ÌÑ¤ ÓÏÂÏÀ C++ API ÄÌÑ
GraphicsMagick (Â¦ÂÌ¦ÏÔÅËÉ ÄÌÑ ÐÅÒÅÇÌÑÄÕ, ËÏÎ×ÅÒÔÕ×ÁÎÎÑ ÔÁ ÏÂÒÏÂËÉ
ÚÏÂÒÁÖÅÎØ).
...
Summary(uk):	èÅÄÅÒÉ ÔÁ Â¦ÂÌ¦ÏÔÅËÉ ÄÌÑ ÒÏÚÒÏÂÏË Ú ×ÉËÏÒÉÓÔÁÎÎÑÍ Magick++ (¦ÎÔÅÒÆÅÊÓÕ C++ ÄÌÑ GraphicsMagick)
Group:		X11/Development/Libraries
...
Summary(uk):	óÔÁÔÉÞÎ¦ Â¦ÂÌ¦ÏÔÅËÉ C++ ÄÌÑ ÐÒÏÇÒÁÍÕ×ÁÎÎÑ Ú GraphicsMagick
Group:		X11/Development/Libraries
...
Summary(uk):	â¦ÂÌ¦ÏÔÅËÉ ÔÁ ÍÏÄÕÌ¦ ÄÌÑ ÄÏÓÔÕÐÕ ÄÏ GraphicsMagick Ú Perl
...
ãÅ ÐÁËÅÔ GraphicsMagick ÄÌÑ Ð¦ÄÔÒÉÍËÉ Perl. ÷¦Î Í¦ÓÔÉÔØ ÍÏÄÕÌ¦ Perl ÔÁ
ÄÏÄÁÔËÏ×¦ ÆÁÊÌÉ ÄÌÑ ÄÏÓÔÕÐÕ ÄÏ Â¦ÂÌ¦ÏÔÅËÉ GraphicsMagick Ú Perl.
